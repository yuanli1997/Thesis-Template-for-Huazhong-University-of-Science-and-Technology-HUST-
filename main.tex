...
\usepackage{amsmath, amsthm, amssymb, amsfonts} % use different mathematical operator
\makeatletter
...
\fancyhead[C]{\begin{CJK*}{UTF8}{gkai} 四川大学本科生院 \end{CJK*}}
\fancyfoot[C]{\thepage}
\renewcommand{\headrulewidth}{0.7pt} % Line at the header visible
\renewcommand{\footrulewidth}{0.7pt} % Line at the footer visible
\patchcmd{\chapter}{\thispagestyle{plain}}{\thispagestyle{fancy}}{}{} % chapter page same header and footer
...
\def\mytitle{The Rise of Machines: before Machine Learning}
...
\def\degree             {Bachelor of Science B.S}
\def\myauthor           {Li Yuan}
\def\authorchinese      {袁立}
\def\studentid          {2015141211078}
\def\major              {Mathematics \& Computer Science}
\def\advisor            {Enbin Song}
\def\school             {Sichuan University}
\def\majorchinese       {数学  \& 计算机}
\def\advisorchinese     {宋恩彬}
\def\schoolchinese      {四川大学}
\def\mydate             {2019.04.24}
\def\mydatechinese      {二零一九 年\ 四 月\ 二十四 日}
